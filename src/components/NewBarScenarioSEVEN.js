...
const BarDominantGreenScenarioSEVEN = (props) => {
    ...
    const { goalDetailState, resultValueAchievement, expectedValueAchievement, scalingLebarSeratusPersen } = props;
            ...
            <Box display="flex" >
                ...
                */}
                <Box 
                    ...
                    // width={ 40 * theme.spacing(0.2) } //*Lebar EVA                    
                    width={ '11%'} //*Lebar EVA                    
