...
export const ToCompletionCompanyStructureQuestionONE = '/completion-company-structure-one';
export const ToCompletionCompanyStructure = '/completion-company-structure-second';
export const ToCompletionCompanyStructureQuestionTHIRD = '/completion-company-structure-third';//* Udah ga kepake !
export const ToCompletionCompanyStructureFormBantuSaya = '/completion-company-structure-empty-form-help-me';

export const ToCompletionCompanyStructureFormulirKosong = '/completion-company-structure-empty-form';
...
export const ToMembershipPaymentStatusAfterCountDown = '/membership-payment-status-after-countdown';
export const ToMembershipStatusIncreaseQuotaSEMENTARA = '/membership-status-increase-quota';
export const ToMembershipStatusScenarioPENDING_SEMENTARA = '/membership-status-pending-or-active';
export const ToMembershipStatusManageSEMENTARA = '/membership-status-manage';
export const ToMembershipStatusManagePENDING_SEMENTARA = '/membership-status-manage-pending';
...
export const ToUserManagementManagePassword = '/user-management-manage-password';
...
export const ToHrEmployeeIdentitasInfoTambahan = '/hr-employee-identity-step-one-c';

export const ToHrEmployeeKeluarga = '/hr-employee-family-step-two';

export const ToHrEmployeeKepegawaianInfoPegawai = '/hr-employee-kpgwn-step-three';
export const ToHrEmployeeKepegawaianInfoPosisi = '/hr-employee-kpgwn-step-three-b';
...
export const ToHrEmployeeRiwayatPendidikanFormal= '/hr-employee-history-step-five-b';
export const ToHrEmployeeRiwayatPendidikanINFORMAL= '/hr-employee-history-step-five-c';
export const ToHrEmployeeRiwayatOrganisasi= '/hr-employee-history-step-five-d';
export const ToHrEmployeeRiwayatPengalamanKerja = '/hr-employee-history-step-five-e';
...
export const ToHrEmployeeProfileDetailSeeDetail = '/hr-employee-profile-detail-see-detail';
...
export const ToLandingPage= '/home*';
